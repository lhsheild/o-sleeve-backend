...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://121.43.183.238:3306/sleeve?allowPublicKeyRetrieval=true&useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai")
                .setDriverName("com.mysql.cj.jdbc.Driver")
                .setUsername("root")
                .setPassword("lh18178007095");
